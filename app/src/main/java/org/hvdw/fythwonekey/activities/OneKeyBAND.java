...
public class OneKeyBAND extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String key_call_option = PreferenceManager.getDefaultSharedPreferences(mContext).getString(MySettings.BAND_CALL_OPTION, "");
        String key_call_entry = PreferenceManager.getDefaultSharedPreferences(mContext).getString(MySettings.BAND_CALL_ENTRY, "");
