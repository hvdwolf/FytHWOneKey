...
public class OneKeyBTPhone extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String key_call_option = PreferenceManager.getDefaultSharedPreferences(mContext).getString(MySettings.BTPHONE_CALL_OPTION, "");
        String key_call_entry = PreferenceManager.getDefaultSharedPreferences(mContext).getString(MySettings.BTPHONE_CALL_ENTRY, "");
